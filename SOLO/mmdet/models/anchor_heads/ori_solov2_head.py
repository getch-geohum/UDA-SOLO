...
def dice_loss(input, target):
    #print('The dice loss shape:', input.shape, target.shape)
...
class SOLOv2Head(nn.Module):
    ...
    def loss(self,
        ...
        ins_labels = [torch.cat([ins_labels_level_img.cuda()
                      ...
                      for ins_labels_level in zip(*ins_label_list)] # only cuda added
        ...
        cate_labels = [
            ...
            for cate_labels_level in zip(*cate_label_list) # only cuda added
        ]
