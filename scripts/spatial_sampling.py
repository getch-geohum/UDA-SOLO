"""This script is usefu for spatial sampling of image chips. Please note that image chips are first generated by ArcGIS pro deep learning tool that exports eimage to classified tiles
